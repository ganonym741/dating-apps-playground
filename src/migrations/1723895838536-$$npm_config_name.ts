...
export class $$npmConfigName1723895838536 implements MigrationInterface {
  name = ' $$npmConfigName1723895838536';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "email" character varying NOT NULL, "username" character varying, "password" character varying NOT NULL, "birth_date" TIMESTAMP NOT NULL, "gender" integer NOT NULL, "address" character varying NOT NULL, "city" character varying NOT NULL, "province" character varying NOT NULL, "photo" character varying NOT NULL, "profile_desc" text, "phone_number" character varying, "membership" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "UQ_78a916df40e02a9deb1c4b75edb" UNIQUE ("username"), CONSTRAINT "UQ_01eea41349b6c9275aec646eee0" UNIQUE ("phone_number"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "user-view" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "viewed_by_id" uuid NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), CONSTRAINT "PK_c97d44064b78f05400b51651e9d" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "user-like" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "liked_by_id" uuid NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), CONSTRAINT "PK_19407b529b1a0ced5065ee8c4b1" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "album" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "photo_1" character varying NOT NULL, "photo_2" character varying, "photo_3" character varying, "photo_4" character varying, "photo_5" character varying, "descriptions" text, "like" integer DEFAULT '0', "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), CONSTRAINT "PK_58e0b4b8a31bb897e6959fe3206" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "album-like" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "album_id" uuid NOT NULL, "liked_by_id" uuid NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), CONSTRAINT "PK_220a7e2eccd3c39d0baa51f3444" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
